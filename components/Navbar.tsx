  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        isIndexPage
          ? scrolled
            ? "bg-nav-bg/80 backdrop-blur-xl shadow-lg shadow-black/20 border-b border-border"
            : "bg-transparent"
          : scrolled
            ? "bg-nav-bg/95 backdrop-blur-xl shadow-lg shadow-black/20"
            : "bg-nav-bg"
      } ${!isIndexPage ? "border-b border-border" : ""}`}
    >
        ...
        <div className="flex items-center justify-between h-16 md:h-[72px]">
          ...
          {isIndexPage ? (
            <div className="flex items-center gap-1">
              <div className="w-8 h-8 rounded-lg bg-primary/10 border border-primary/20 flex items-center justify-center mr-1">
                <svg
                  width="16"
                  height="16"
                  viewBox="0 0 24 24"
          ...
          {/* ===== Desktop Navigation (hidden on Index page) ===== */}
          {!isIndexPage && (
          ...
          {/* ===== Mobile Hamburger (hidden on Index page) ===== */}
          {!isIndexPage && (
            <button
      ...
      {/* ===== Mobile Menu Overlay (hidden on Index page) ===== */}
      {!isIndexPage && (
        <div
      ...
      {/* ===== Mobile Menu Panel (hidden on Index page) ===== */}
      {!isIndexPage && (
        <div
